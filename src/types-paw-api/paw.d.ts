...
export interface DynamicValuePlugin {
...
declare global {
  ...
  function registerDynamicValueClass(dynamicValue: any): void

  function InputField(key: string, name: string, type: DataType, options?: FieldOptions): any
}